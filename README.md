...
| Core     | Dynamic Workflow Builder                                                             |     ❌ | P2       | M        | Build flows using FlowCHart or similar                                                                              | `projects/core/shred/*`                                                                                | TO BE IMPLEMENTED                                         | FE    |
| Core     | Charts                                                                               |     ❌ | P2       | M        | Display charts using D3 js or chartsJs or similar                                                                   | `projects/core/shred/*`                                                                                | TO BE IMPLEMENTED                                         | FE    |
